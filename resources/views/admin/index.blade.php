...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="index.html"><em class="fa fa-dashboard">&nbsp;</em> Table 1</a></li>
			<li><a href="widgets.html"><em class="fa fa-calendar">&nbsp;</em> Table 2</a></li>
			<li><a href="Seafood"><em class="fa fa-bar-chart">&nbsp;</em> Home</a></li>
