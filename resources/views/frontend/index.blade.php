...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(frontend/assets/images/testbg3.jpg);">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(frontend/assets/images/bg1.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(frontend/assets/images/bg2.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
								<!-- Pic block2 -->
								<a href="frontend/assets/#" class="wrap-pic-blo2 bg1-blo2" style="background-image: url(images/event-02.jpg);">
								...
								<div class="wrap-text-blo2 flex-col-c-m p-l-40 p-r-40 p-t-45 p-b-30">
									...
									<a href="frontend/assets/#" class="txt4 m-t-40">
										View Details
										<i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i>
									</a>
								</div>
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="fadeInDown">
								<!-- Pic block2 -->
								<a href="frontend/assets/#" class="wrap-pic-blo2 bg2-blo2" style="background-image: url(images/event-06.jpg);">
									<div class="time-event size10 txt6 effect1">
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="rotateInUpLeft">
								<!-- Pic block2 -->
								<a href="frontend/assets/#" class="wrap-pic-blo2 bg3-blo2" style="background-image: url(images/event-01.jpg);">
									<div class="time-event size10 txt6 effect1">
										<span class="txt-effect1 flex-c-m">
											08:00 PM Tuesday - 21 November 2018
										</span>
			...
			<div class="row">
				...
				<div class="col-lg-6 p-b-30 p-t-18">
					<div class="wrap-pic-booking size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="frontend/assets/images/booking-01.jpg" alt="IMG-OUR">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="frontend/assets/blog-detail.html"><img src="frontend/assets/images/blog-01.jpg" alt="IMG-INTRO"></a>
						...
						<div class="wrap-text-blo1 p-t-35">
							<a href="frontend/assets/blog-detail.html"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
							...
							<a href="frontend/assets/blog-detail.html" class="txt4">
								Continue Reading
								<i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i>
							</a>
						</div>
				...
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="frontend/assets/blog-detail.html"><img src="frontend/assets/images/blog-02.jpg" alt="IMG-INTRO"></a>
				...
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="frontend/assets/blog-detail.html"><img src="frontend/assets/images/blog-03.jpg" alt="IMG-INTRO"></a>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-4 p-t-50">
					...
					<div class="m-b-25">
						...
						<a href="frontend/assets/#" class="txt15">
							@colorlib
						</a>
				...
				<div class="col-sm-6 col-md-4 p-t-50">
					...
					<div class="wrap-gallery-footer flex-w">
						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-01.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-01.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-02.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-02.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-03.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-03.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-04.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-04.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-05.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-05.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-06.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-06.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-07.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-07.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-08.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-08.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-09.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-09.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-10.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-10.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-11.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-11.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="frontend/assets/images/photo-gallery-12.jpg" data-lightbox="gallery-footer">
							<img src="frontend/assets/images/photo-gallery-thumb-12.jpg" alt="GALLERY">
						</a>
					</div>
			...
			<div class="container">
				<div class="flex-sb-m flex-w p-t-22 p-b-22">
					<div class="p-t-5 p-b-5">
						<a href="frontend/assets/#" class="fs-15 c-white"><i class="fa fa-tripadvisor" aria-hidden="true"></i></a>
						<a href="frontend/assets/#" class="fs-15 c-white"><i class="fa fa-facebook m-l-18" aria-hidden="true"></i></a>
						<a href="frontend/assets/#" class="fs-15 c-white"><i class="fa fa-twitter m-l-18" aria-hidden="true"></i></a>
					</div>

					<div class="txt17 p-r-20 p-t-5 p-b-5">
						Copyright &copy; 2018 All rights reserved  |  This template is made with <i class="fa fa-heart"></i> by <a href="frontend/assets/https://colorlib.com" target="_blank">Colorlib</a>
					</div>
				</div>
			</div>
		</div>
